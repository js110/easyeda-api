...
- 返回值：Promise<[ILIB\_DeviceItem](../interfaces/ILIB_DeviceItem.md) \| undefined>
...
默认验证记录会写到 `examples/reports/latest.json`，该案例的索引键是 `LIB_Device.get`。
