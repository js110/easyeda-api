...
- 返回值：Promise<[IPCB\_PrimitiveDimension](./IPCB_PrimitiveDimension.md) \| undefined>
...
默认验证记录会写到 `examples/reports/latest.json`，该案例的索引键是 `PCB_PrimitiveDimension.modify`。
